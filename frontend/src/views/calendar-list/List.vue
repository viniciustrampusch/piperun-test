    ...
    <div class="container-fluid">
      <div class="row mt-4">
          <div class="col-8 offset-2">
            <h2 v-if="user && user.id === requested.id">Meus agendamentos</h2>
            <h2 v-else>Agendamentos de {{requested.name}}</h2>
            ...
            <table class="table table-bordered table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th>Solicitado</th>
                  <th>Status</th>
                  <th v-if="user.perfil === 'admin'">Ações</th>
                </tr>
              </thead>
              <tbody>
